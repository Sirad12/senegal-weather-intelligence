...
"""
#store_to_minio.py est un  consommateur Kafka qui lit les données météorologiques, 
# les valide selon des règles définies, et les stocke dans MinIO au format Parquet. 
# Il utilise deux buckets : un pour les données brutes et un pour les données traitées. 
# Les données sont organisées en partitions basées sur la région, la source et la date.
