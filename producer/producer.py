...
# ── Kafka Producer ─────────────────────────────────────────────────────────────
# La fonction build_producer() tente de se connecter à Kafka en utilisant les paramètres de configuration définis.
# Elle réessaie plusieurs fois en cas d'échec, avec un délai entre les tentatives, et retourne un objet KafkaProducer configuré pour sérialiser les messages en JSON.
