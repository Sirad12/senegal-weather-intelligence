...
#── Mode démo ───────────────────────────────
#le mode demo sert à générer des points de données météorologiques aléatoires pour chaque région,
# en utilisant des températures de base réalistes pour chaque région et en ajoutant une variation aléatoire.
#il intervient lorsque Kafka n'est pas disponible, permettant ainsi de tester et de démontrer le dashboard même sans connexion à Kafka.
...
if not df_all.empty and len(df_all) > 2:
    ...
    # ── Rose des vents ─────────────────────────────────────────────────────────
    # La rose des vents est un graphique polaire qui représente la distribution de la direction et de la vitesse du vent pour une région donnée.
